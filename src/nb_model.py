...
if __name__ == "__main__":
    ...
    categories = ['Acceptance, Waiver & Consent(AWC)', 'Consent', 'Decision',
       'Decision & Order of Offer of Settlement', 'Dismissed',
       'Favorable for Broker', 'Judgment Rendered', 'Order', 'Other',
       'Settled', 'Stipulation and Consent', 'Withdrawn']

    # Create train & test splits
    y_train_validation = df_finra['resolution']
